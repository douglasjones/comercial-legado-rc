...
function fcMontarContextoTransferencia(){
    var v_ic_status_1 = 0;
    var v_ic_status_2 = 0;
    var v_ic_status_3 = 0;
    var v_ic_status_4 = 0;
    ...
    return {
        ...
        tempo_contrato_ini: $("#tempo_contrato_ini").val(),
        tempo_contrato_fim: $("#tempo_contrato_fim").val(),
...
function fcPesquisar(){
    var objContexto = fcMontarContextoTransferencia();

    try{
        window.sessionStorage.setItem("transferencia_lead_context", JSON.stringify(objContexto));
    }
    catch(e){
        console.warn("Transferencia Lead: falha ao persistir contexto no sessionStorage.", e);
    }

    sendPost('transferencia_lead2.php', objContexto);
...
$(document).ready(function(){
    ...
    $("#tempo_contrato_ini").keypress(function(){
        mascara(this,soNumeros);
    });
    $("#tempo_contrato_fim").keypress(function(){
        mascara(this,soNumeros);
    });
