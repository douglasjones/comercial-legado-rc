...
function fcCarregarGrid(){
    ...
    //Cria url
    var v_url = "../controller/grupo.controller.php?job=listarDataTable&token="+token+"&ds_grupo="+$("#ds_grupo").val()+"&polos_pk="+$("#polos_pk").val();
    ...
    tblResultado = $('#tblResultado').DataTable({
        ...
        "columnDefs": [{
                "targets": -1,
                "data": null,
                "defaultContent": "<a class='function_edit' title='Editar'><span><i class='fa fa-pencil-square-o' style='font-size: 15px;'></i></span></a>    <a class='function_delete' title='Excluir'><span><i class='fa fa-trash' style='font-size: 15px;'></span></a>"
            },
...
$(document).ready(function(){
    var arrCarregar = permissao("grupo", "cons");        
