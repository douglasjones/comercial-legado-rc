...
<script src="mailing_cad_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form id="form" class="form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for="ic_status">Polos:&nbsp;</label>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <label for='ds_mailing'>Mailing:&nbsp;</label>
                <input type='text' class='form-control form-control-sm' id='ds_mailing' name='ds_mailing' required >
            </div>
        </div>
