                        ...
                        <div class="modal-body" >                                    
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-3'>
                                    ...
                                    <select class='form-control form-control-sm'  id='agenda_atendente_pk' name='agenda_atendente_pk'>
                                        <option></option>
                                    </select>
                                </div>                                
                            </div>
                            ...
                            <div >
                                ...
                                <div id="exib_com_pk">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-md-5'>
                                            <label for='ds_contato'>E-mail:&nbsp;</label>
                            ...
                            <div class="row" id='exib_obs'>
                                ...
                                <div class='col-md-8'>
                                    <label for='ds_obs_visita_agenda'>Observação da Visita: </label>
                                    <textarea class='form-control form-control-sm' id='ds_obs_visita_agenda' name='ds_obs_visita_agenda' ></textarea>
                                </div>                                        
                            </div>
