...
class transferencia_leaddao{
    ...
    public function listarQtdeLead($polos_pk,$ds_razao_social,$ic_status_1,$ic_status_2,$ic_status_3,$ic_status_4,$grupos_pk,$usuarios_pk,$tipo_pessoa_pk,$mailing_pk,$operador_pk,$classificacao_operador_pk,$tempo_contrato_pk,$qtde_linhas_ini,$qtde_linhas_fim){
        ...
        if($operador_pk != "" || $classificacao_operador_pk != "" || $tempo_contrato_pk != "" || $qtde_linhas_ini != "" || $qtde_linhas_fim != ""){
    ...
    public function TransferirLead($polos_pk,$ds_razao_social,$ic_status_1,$ic_status_2,$ic_status_3,$ic_status_4,$grupos_pk,$usuarios_pk,$tipo_pessoa_pk,$mailing_pk,$operador_pk,$classificacao_operador_pk,$tempo_contrato_pk,$qtde_linhas_ini,$qtde_linhas_fim,$total_transferencia){
