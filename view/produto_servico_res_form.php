...
?>
<script src="produto_servico_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
    ...
    <form method="post">
        ...
        <div class="row">
            ...
            <div class='col-md-4'>
                ...
                <input type="text" class="form-control form-control-sm" id="ds_produto_servico" required="true">
            </div>
        </div>
        <div class='row'>
            <div class='col-md-4'>
