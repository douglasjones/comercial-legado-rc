...
?>
<script src="polo_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
...
<div class="container">
    ...
    <form method="post">
        <!--<div class="row">
            ...
            <div class='col-md-4'>
                <label for="ds_polo">Conta:&nbsp;</label>
                <select class='form-control form-control-lg'  id='contas_pk' name='contas_pk' />
                    <option></option>
                </select>
            </div>
        </div>-->
