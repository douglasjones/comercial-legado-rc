...
function carregarGraficoFunil(){
        ...
        var arrSeries = [];  
        var url = "../controller/grafico_funil_vendas_controller.php?token="+token;
        //pega as informações
...
function carregarGraficoAgenda(){
    ...
    var arrCategories = [];  
        var url = "../controller/grafico_agendamento_controller.php?token="+token;
        //pega as informações
        $.getJSON(url, function(result) {
...
$(document).ready(function(){
    ...
    //ADMINISTRADOR GEPROS
    //if($("#usuairo_logado_grupos_pk").val()==1){
        
        //INFORMATIVO AGENDAS
        $('#exibir_informativo_agenda').show();

        // RETORNO
        $('#exibir_retorno').show();

        // AGENDA VISITA
        $('#exibir_agenda_visita').show();

        // CONTRATO
        $('#exibir_contrato').show();

        // FUNIL VENDAS
        $('#exibir_funil_vendas').show();

        // PROPOSTA
        $('#exibir_proposta_dashboard').show();
