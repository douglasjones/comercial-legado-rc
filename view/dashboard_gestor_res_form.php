...
?>
<script src="dashboard_gestor_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<div class="container"> 
    <table>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <select class='form-control form-control-sm'  id='polos_pk_dashboard' name='polos_pk_dashboard' >
                    <option></option>
                </select> 
            </td>
        </tr>
